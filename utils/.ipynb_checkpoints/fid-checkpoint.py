...
def calculate_fid(imgs1, imgs2, use_multiprocessing, batch_size):
    ...
    imgs1 = torch.stack([transfer_img(img) for img in imgs1], dim=0)
    imgs2 = torch.stack([transfer_img(img) for img in imgs2], dim=0)
